...
public class LoginActivity_1 extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String TAG = LoginActivity_1.class.getName();
    ...
    private boolean mayRequestContacts() {
        ...
        /* Pop up for contacts permission
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            Toast.makeText(LoginActivity_1.this, R.string.error_invalid_username,
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            //Success
                            logInName = getCurrentUser();
                            Toast.makeText(LoginActivity_1.this,"Welcome "+logInName,Toast.LENGTH_SHORT).show();
    ...
    public String getCurrentUser(){
        ...
        String name="No name";
        if (user != null) {
            // Name, username address, and profile photo Url
